 ...
 * @author user-pc
 */
public class viewTransaksiKasir extends javax.swing.JInternalFrame {

    /**
     * Creates new form viewTransaksi
     */
    viewFormTransaksiKasir vFTK= new viewFormTransaksiKasir();
    viewDataTransaksiKasir vDTK= new viewDataTransaksiKasir();
    ...
    private void transaksiBTMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_transaksiBTMouseClicked
        ...
        this.transaksiPanel.remove(vDTK);
        this.transaksiPanel.add(vFTK);
        vFTK.show();
    ...
    private void dataTransaksiBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataTransaksiBTActionPerformed
        // TODO add your handling code here:
        this.transaksiPanel.remove(vFTK);
        this.transaksiPanel.add(vDTK);
        vDTK.show();
